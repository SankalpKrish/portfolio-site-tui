...
export const help: CommandHandler = () => ({ html: `
  ...
  <div class="cc-tool-result"><span class="cc-tool-result-sym">&#x2B0F;</span><span class="cc-tool-result-text">Found 6 commands</span></div>
  <div class="cc-output-block" style="font-size:12px;line-height:2;">
    ...
    <div><span style="color:var(--blue);min-width:130px;display:inline-block;">/clear</span><span style="color:var(--overlay0)">&rarr;</span> <span style="color:var(--subtext0)">clear the terminal</span></div>
