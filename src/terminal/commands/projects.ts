...
export const projects: CommandHandler = () => ({ html: `
  ...
  <div class="cc-output-block" style="display:flex;flex-direction:column;gap:10px;">
    ...
    <div style="border:1px solid rgba(180,190,254,0.10);border-radius:4px;padding:12px 14px;">
      ...
      <div style="color:var(--overlay1);font-size:11px;margin:2px 0;">projects/midi-ai/ &middot; Dec 2025 &middot; Solo</div>
      ...
      <div style="font-size:11px;color:var(--mauve);">&#x2B0F; /open midi.ai &mdash; open on GitHub</div>
    </div>

    <div style="border:1px solid rgba(180,190,254,0.10);border-radius:4px;padding:12px 14px;">
      <div style="color:var(--lavender);font-weight:600;font-size:13px;">&#x2B21; OpenComputer</div>
      <div style="color:var(--overlay1);font-size:11px;margin:2px 0;">projects/opencomputer/ &middot; May 2026 &middot; Collab</div>
      ...
      <div style="font-size:11px;color:var(--mauve);">&#x2B0F; /open opencomputer &mdash; open on GitHub</div>
    </div>

    <div style="border:1px solid rgba(180,190,254,0.10);border-radius:4px;padding:12px 14px;">
      <div style="color:var(--lavender);font-weight:600;font-size:13px;">&#x2B21; The Procrastination Engine</div>
      <div style="color:var(--overlay1);font-size:11px;margin:2px 0;">projects/procrastination-engine/ &middot; Oct 2025 &middot; For fun</div>
      ...
      <div style="font-size:11px;color:var(--mauve);">&#x2B0F; /open procrastination-engine &mdash; open on GitHub</div>
    </div>
